...
from AliciaMusic.modules.play import generate_cover
from AliciaMusic.modules.play import arq
from AliciaMusic.modules.play import cb_admin_check
from AliciaMusic.modules.play import transcode
from AliciaMusic.modules.play import convert_seconds
from AliciaMusic.modules.play import time_to_seconds
from AliciaMusic.modules.play import changeImageSize
...
from AliciaMusic.support.helpers.channelmusic import get_chat_id
from AliciaMusic.support.helpers.decorators import authorized_users_only
from AliciaMusic.support.helpers.filters import command, other_filters
from AliciaMusic.support.helpers.gets import get_file_name
from AliciaMusic.support.callsmusic import callsmusic, queues
...
from AliciaMusic.config import BG_IMAGE
from AliciaMusic.config import PROJECT_NAME
from AliciaMusic.config import BOT_USERNAME
from AliciaMusic.config import ASSISTANT_USERNAME
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @{BOT_USERNAME} and @{ASSISTANT_USERNAME} to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
