...
@Aliciabot.on_message(filters.command("song") & ~filters.channel)
def song(client, message):
    ...
    try:
        ...
        rep = f"**🎵 Uploaded by [{bn}](https://t.me/{BOT_USERNAME})**"
...
@Aliciabot.on_message(filters.command("saavn") & ~filters.edited)
...
@Aliciabot.on_message(filters.command("deezer") & ~filters.edited)
...
@Aliciabot.on_message(filters.command(["vsong", "video"]))
